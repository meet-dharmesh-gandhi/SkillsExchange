	...
	return (
		<main className="min-h-screen bg-[radial-gradient(circle_at_top,#f2f7ff_0%,#f8f9fb_45%,#edf3f1_100%)] px-4 py-8 text-slate-800">
			<div className="mx-auto w-full max-w-6xl">
				<header className="mb-8 rounded-2xl border border-slate-200 bg-white/85 p-6 shadow-sm backdrop-blur-sm">
				...
				<section className="mt-6 rounded-2xl border border-slate-200 bg-slate-950 p-5 text-slate-100 shadow-md">
